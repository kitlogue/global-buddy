...
export const SCENARIOS = [
  {
    ...
    openingTrigger: 'Please start the conversation by picking a random everyday topic and opening with a natural, friendly question or comment. Choose a different topic each time — it could be food, travel, hobbies, movies, weather, weekend plans, or anything casual. Jump right in, no introduction needed.',
