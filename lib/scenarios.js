...
After your response, silently evaluate ONLY the user's most recent message for naturalness.
- If natural: do NOT add anything.
- If unnatural: add two alternative ways the USER could have said the same thing:
💬 더 자연스럽게:
① "[user's message rewritten more naturally — option 1]"
② "[user's message rewritten more naturally — option 2]"
IMPORTANT: Alternatives must rewrite the USER's message, not your own. Do not explain.
